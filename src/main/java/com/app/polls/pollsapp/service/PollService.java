package com.app.polls.pollsapp.service;

import com.app.polls.pollsapp.exception.BadRequestException;
import com.app.polls.pollsapp.exception.ResourceNotFoundException;
import com.app.polls.pollsapp.model.*;
import com.app.polls.pollsapp.payload.PagedResponse;
import com.app.polls.pollsapp.payload.PollRequest;
import com.app.polls.pollsapp.payload.PollResponse;
import com.app.polls.pollsapp.payload.VoteRequest;
import com.app.polls.pollsapp.repository.PollRepository;
import com.app.polls.pollsapp.repository.UserRepository;
import com.app.polls.pollsapp.repository.VoteRepository;
import com.app.polls.pollsapp.security.UserPrincipal;
import com.app.polls.pollsapp.util.AppConstants;
import com.app.polls.pollsapp.util.ModelMapper;
...
public class PollService {
    ...
    public PagedResponse<PollResponse> getAllPolls(UserPrincipal currentUser, int page, int size) {
        ...
        // Map polls to PollReponses containing vote counts and poll creator details
    ...
    public PagedResponse<PollResponse> getPollsVotedBy(String username, UserPrincipal currentUser, int page, int size) {
        ...
        // Retrieve all pollIds in which a given username has voted
    ...
    public PollResponse castVoteAndGetUpdatedPoll(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser) {
        ...
        // Retrieve Vote counts for each Choice belonging to the current Poll
        List<ChoiceVoteCount> votes =  voteRepository.countByPollIdGroupByChoiceId(pollId);
    ...
    private void validatePageNumberAndSize(int page, int size) {
        ...
        if(size > AppConstants.MAX_PAGE_SIZE) {
            throw new BadRequestException("Page size must be greater than "+ AppConstants.DEFAULT_PAGE_SIZE);
        }
    }
